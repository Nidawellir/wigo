...
protocol YourNameViewDelegate: AnyObject {
...
final class YourNameView: UIView {
    ...
    weak var delegate: YourNameViewDelegate?
    ...
    private func didTapContinueButton() {
        ...
        delegate?.didTapContinueButton(with: name)
        delegate?.openYourBirtday()
    }
